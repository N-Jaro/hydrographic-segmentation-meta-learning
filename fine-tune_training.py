...
from libs.unet import SimpleUNet, DeeperUnet, DeeperUnet_dropout, SimpleAttentionUNet, ResNet50Unet
...
def setup_model(model_type, input_shape, num_classes):
    ...
    elif model_type == "ResNet50Unet":
        model_creator = ResNet50Unet(input_shape=input_shape, output_mask_channels=num_classes)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_folder', type=str, default='./5_kmean_clusters/', help='Input folder containing train and test CSV files')
    parser.add_argument('--data_dir', type=str, default='./data_wo_254_255/huc_code_data_znorm_128/', help='Directory containing the .npy files')
    parser.add_argument('--model_save_dir', type=str, default='./experiments/', help='Directory to save the trained models')
    parser.add_argument('--metrics_save_dir', type=str, default='./experiments/', help='Directory to save the evaluation metrics')

    parser.add_argument('--model', type=str, default='unet', choices=['unet', 'deeperUnet', 'deeperUnetDropout', 'simpleAttentionUnet', 'attentionUnet', 'RestNet50Unet'], help='Model architecture')
    ...
    parser.add_argument('--channels', type=int, nargs='+', default=[0, 1, 2, 3, 4, 6, 7, 8, 9, 10], help='Channels to use in the dataset (e.g., 0 1 2 3 4 6 7 8 9 10)')
