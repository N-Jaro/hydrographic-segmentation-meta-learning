...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', type=str, default='./data_wo_254_255/huc_code_data_znorm_128/', help='Path to data directory')
    parser.add_argument('--save_path', type=str, default='./experiments/', help='Path to save trained models')
    parser.add_argument('--clusters_dir', type=str, default='./5_kmean_clusters/', help='Path to training CSV file')
